...
class Ising1d : public SpinHamiltonian {
  ...
  public:
    ...
    //Constructor and Destructor
    Ising1d(unsigned int, double, int, double j=1.0, bool pbc=true);
    ~Ising1d(){}
...
class Heisenberg1d : public SpinHamiltonian {
  ...
  public:
    ...
    //Constructor and Destructor
    Heisenberg1d(unsigned int, int, double hfield=0.0, double jx=-1.0, double jy=-1.0, double jz=-1.0, bool pbc=true);
    ~Heisenberg1d(){}
...
/******************************************  𝐓𝐑𝐀𝐍𝐒𝐕𝐄𝐑𝐒𝐄 𝐅𝐈𝐄𝐋𝐃 𝐈𝐒𝐈𝐍𝐆 𝐌𝐎𝐃𝐄𝐋 𝐢𝐧 𝐝 = 𝟏  *******************************************/
/*******************************************************************************************************************************/
Ising1d :: Ising1d(unsigned int n_spin, double h_field, int rank, double j, bool pbc)
...
/*************************************************  𝐇𝐄𝐈𝐒𝐄𝐍𝐁𝐄𝐑𝐆 𝐌𝐎𝐃𝐄𝐋 𝐢𝐧 𝐝 = 𝟏  ************************************************/
/*******************************************************************************************************************************/
Heisenberg1d :: Heisenberg1d(unsigned int n_spin, int rank, double h_field, double jx, double jy, double jz, bool pbc)
